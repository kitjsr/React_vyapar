...
export const Invoice = () => {
    const[balance,invoiceAmount,received,setBalance]=useState(0.00);
    const balance1=() => {
            ...
            <Col md={6} className='heading'>
                ...
                <Form>
                    <Row className='invoice1'>
                        <Col md={6}>
                            <p><MDBIcon fas icon="file-invoice" />Invoice Details :</p>
                        ...
                        <Col>
                            <Alert variant="success">
                                <Row>
                                    ...
                                    <Col md={6} className='am'>{balance}</Col>
                                </Row>
                            </Alert>
                    ...
                    <Row>
                        <Col className='but2'>
                            <Button type="submit" className='but3'>Create your invoice</Button>
                        </Col>
                    </Row>
                </Form>
            </Col>
            <Col md={6} className='sample'>
                <h5>Sample Invoice</h5><br/>
                <Image src="https://consumercomplaintscourt.com/wp-content/uploads/IMG-20230413-WA0068.jpg" className='img'/>
            </Col>
        </Row>
    </Container>
  )
